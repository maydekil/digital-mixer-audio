...
constexpr std::array<EffectDescriptor, 12> kCatalog{{
  ...
  {"chorus", "Chorus", EffectCategory::modulation, 1, ChannelFormat::monoToStereo, ChannelFormat::stereo,
    EffectAvailability::implementedUnverified, "dsp/fx/ModulationEffects", "VFX-02", "fractional delay modulation sweep"},
  {"doubler", "Vocal Doubler", EffectCategory::modulation, 1, ChannelFormat::monoToStereo, ChannelFormat::stereo,
    EffectAvailability::implementedUnverified, "dsp/fx/DoublerEffect", "VFX-03", "two independent micro-delay voices"},
  {"pitch_shift", "Pitch Shift", EffectCategory::pitch, 1, ChannelFormat::mono, ChannelFormat::mono,
    EffectAvailability::implementedUnverified, "dsp/fx/PitchBackend", "VFX-04", "steady frequency shift and latency"},
  ...
  {"flanger", "Flanger", EffectCategory::modulation, 1, ChannelFormat::monoToStereo, ChannelFormat::stereo,
    EffectAvailability::implementedUnverified, "dsp/fx/ModulationEffects", "VFX-02", "comb sweep and bounded feedback"},
