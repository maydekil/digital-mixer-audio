...
contextBridge.exposeInMainWorld("localMixer", {
  ...
  writeProjectAutosave: (content: string) => ipcRenderer.invoke("project:write-autosave", content),
  readProjectAutosave: () => ipcRenderer.invoke("project:read-autosave"),
  clearProjectAutosave: () => ipcRenderer.invoke("project:clear-autosave"),
