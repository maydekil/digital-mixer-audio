...
| 12 native Vocal FX families | Vocal FX tab | VFX rack contracts | `EffectRegistry`, `EffectProcessorFactory`, `EffectRack`, individual FX processors | vocal FX slots/presets | VFX CTest suite, `EffectProcessorFactoryTest` | 10 catalog effects have production processor factory coverage; pitch-shift/formant wrappers, live insertion, and final listening QA pending | `PARTIAL` |
