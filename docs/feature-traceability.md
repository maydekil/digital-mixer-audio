...
| 12 native Vocal FX families | Vocal FX tab | VFX rack contracts | `EffectRegistry`, `EffectProcessorFactory`, `EffectRack`, individual FX processors | vocal FX slots/presets | VFX CTest suite, `EffectProcessorFactoryTest`, `PitchShiftEffectsTest` | 12/12 catalog effects have production processor factory coverage; live insertion and final listening QA pending | `PARTIAL` |
