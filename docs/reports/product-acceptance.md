...
- Native realtime insert graph has initial channel processor wiring for EQ/NOISE/COMP flags, but still needs full parameter sync, de-esser control, Vocal FX, FX A/B, Harmony, export parity, and live callback QA.
