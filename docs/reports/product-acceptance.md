...
- Native realtime insert graph and monitor selection have initial channel processor wiring for EQ band values, compressor parameters, de-esser parameters, and NOISE/COMP flags, but still need Vocal FX, FX A/B, Harmony, export parity, and live callback/listening QA.
...
- Product-level performance metrics, callback deadlines, xruns, and 32-track stress are not implemented.
