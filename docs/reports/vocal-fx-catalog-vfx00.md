...
- `implemented_unverified`: `reverb`, `delay`, `chorus`, `doubler`, `saturation`, `flanger`, `phaser`
- `unavailable`: `pitch_shift`, `formant_shift`, `pitch_correct`, `harmony`, `vocoder`
- `verified`: none
...
- Latest result: PASS, CTest 24/24
