...
- `implemented_unverified`: `reverb`, `delay`, `chorus`, `doubler`, `saturation`, `flanger`, `phaser`, `pitch_shift`, `formant_shift`, `pitch_correct`, `harmony`
- `unavailable`: `vocoder`
- `verified`: none
...
- Latest result: PASS, CTest 27/27
