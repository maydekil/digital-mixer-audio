...
- `implemented_unverified`: `reverb`, `delay`, `chorus`, `doubler`, `saturation`, `flanger`, `phaser`, `pitch_shift`, `formant_shift`, `pitch_correct`
- `unavailable`: `harmony`, `vocoder`
- `verified`: none
...
- Latest result: PASS, CTest 26/26
